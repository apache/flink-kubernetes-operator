...
| flinkConfiguration | java.util.Map<java.lang.String,java.lang.String> | Flink configuration overrides for the Flink deployment. Check supported configurations in [Operator Configuration]({{< ref "docs/operations/configuration" >}}) and [Flink Configuration](https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/) |
...
| flinkConfiguration | java.util.Map<java.lang.String,java.lang.String> | Flink configuration overrides for the Flink deployment. Check more information in [Operator Configuration]({{< ref "docs/operations/configuration#job-specific-configuration-reference" >}}) and [Flink Configuration](https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/config/). |
