...
Knowing what lives where is what makes the operational calls on this page possible: what a backup must include, what is safe to clean up, what a GitOps tool should ignore, and where to look when debugging.
