...
import org.apache.flink.autoscaler.TestScalingExecutorPlugin;
...
class AutoscalerUtilsTest {
    ...
    void testDiscoverCustomScalingExecutors() {
        ...
        assertThat(scalingExecutors)
                .as(
                        "Expected to discover the TestScalingExecutorPlugin registered under META-INF/services")
                .hasSize(1)
                .hasOnlyElementsOfType(TestScalingExecutorPlugin.class);
    }
}
