...
import org.apache.flink.kubernetes.operator.utils.ScalingMetricEvaluatorHookUtils;
...
public class AutoscalerFactory {
    ...
    public static JobAutoScaler<ResourceID, KubernetesJobAutoScalerContext> create(
        ...
        var scalingMetricEvaluatorHooks =
                ScalingMetricEvaluatorHookUtils.discoverScalingMetricEvaluatorHooks(configManager);
