...
public class MissingJobManagerException extends RuntimeException {
    public MissingJobManagerException(Throwable cause) {
        super(cause);
    }

    public MissingJobManagerException(String msg) {
        super(msg);
    }

    public MissingJobManagerException(String msg, Throwable cause) {
        super(msg, cause);
    }
}
