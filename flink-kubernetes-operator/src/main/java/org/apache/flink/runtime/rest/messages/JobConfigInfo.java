...
/**
 * Copied from Flink 1.20 to parse job config responses from all supported Flink versions, with
 * small modifications: {@code executionMode} is nullable because the deprecated {@code
 * execution-mode} field was removed in Flink 2.0, and the nested {@link ExecutionConfigInfo} is
 * parsed with the flexible object mapper so fields added by future Flink versions are tolerated.
 */
...
public class JobConfigInfo implements ResponseBody {
    ...
    public static final class ExecutionConfigInfo {
        ...
        /** Removed in Flink 2.0, only returned by Flink 1.x. */
        @Deprecated
        @Nullable
        ...
        public ExecutionConfigInfo(
                @JsonProperty(FIELD_NAME_EXECUTION_MODE) @Nullable String executionMode,
