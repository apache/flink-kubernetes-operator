...
/** Tests for operator {@link AutoscalerUtils} plugin discovery. */
public class AutoscalerUtilsTest {

    @TempDir public Path temporaryFolder;

    @Test
    void discoverAlignmentModesReturnsEmptyWithoutPlugins() {
        // With no plugins directory configured, discovery succeeds and returns no custom modes.
        assertThat(AutoscalerUtils.discoverAlignmentModes(new Configuration())).isEmpty();
    }

    @Test
    public void testDiscoverAlignmentModesFromPlugins() throws IOException {
        ...
        try {
            ...
            assertThat(AutoscalerUtils.discoverAlignmentModes(new Configuration()))
